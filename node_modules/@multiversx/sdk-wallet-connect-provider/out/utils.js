...
exports.getExistingConnectionParams = getExistingConnectionParams;
exports.getMvxNamespace = getMvxNamespace;
...
function getExistingConnectionParams(chainId, options) {
    const requiredNamespaces = getMvxNamespace(chainId, options);
    return {
        requiredNamespaces,
    };
}
function getMvxNamespace(chainId, options) {
    var _a, _b, _c;
    const methods = [
...
function addressIsValid(destinationAddress) {
    try {
        const address = sdk_core_1.Address.newFromBech32(destinationAddress);
