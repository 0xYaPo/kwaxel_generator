...
export declare function getConnectionParams(chainId: string, options?: ConnectParamsTypes): EngineTypes.ConnectParams;
export declare function getExistingConnectionParams(chainId: string, options?: ConnectParamsTypes): EngineTypes.FindParams;
export declare function getMvxNamespace(chainId: string, options?: ConnectParamsTypes): ProposalTypes.OptionalNamespaces;
