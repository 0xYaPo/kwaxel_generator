    ...
    signTransactions(transactions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const transactionsResponse = metamaskReponse.map((transaction) => Transaction.newFromPlainObject(JSON.parse(transaction)));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return new Message({
                    ...
                    address: (_b = messageToSign.address) !== null && _b !== void 0 ? _b : Address.newFromBech32(this.account.address),
                    signer: 'metamask',
