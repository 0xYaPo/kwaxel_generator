...
const SpinnerIcon = /*@__PURE__*/ proxyCustomElement(class SpinnerIcon extends H {
    ...
    render() {
        return (h("svg", { key: 'e1b851bdc25045181c795b670c580b1dab5a9132', viewBox: "0 0 512 512", xmlns: "http://www.w3.org/2000/svg", class: { spinner: true, [this.class]: Boolean(this.class) } }, h("path", { key: 'b0b1eb52884b8b7ad8d65d9014cec35fcaa4b3a1', d: "M304 48a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zm0 416a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM48 304a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm464-48a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM142.9 437A48 48 0 1 0 75 369.1 48 48 0 1 0 142.9 437zm0-294.2A48 48 0 1 0 75 75a48 48 0 1 0 67.9 67.9zM369.1 437A48 48 0 1 0 437 369.1 48 48 0 1 0 369.1 437z" })));
    }
    static get style() { return spinnerIconCss; }
}, [257, "mvx-spinner-icon", {
        "class": [1]
    }]);
function defineCustomElement() {
    ...
    const components = ["mvx-spinner-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-spinner-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, SpinnerIcon);
            }
            break;
    } });
}

export { SpinnerIcon as S, defineCustomElement as d };
