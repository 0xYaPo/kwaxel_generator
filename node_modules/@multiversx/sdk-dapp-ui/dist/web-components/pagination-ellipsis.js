...
const PaginationEllipsis = /*@__PURE__*/ proxyCustomElement(class PaginationEllipsis extends H {
    ...
    render() {
        return h("div", { key: '6d6b86650759c125ec5cb419c345020c7511db3d', class: { 'pagination-ellipsis': true, 'active': this.isActive } }, ELLIPSIS);
    }
    static get style() { return paginationEllipsisCss; }
}, [257, "mvx-pagination-ellipsis", {
...
function defineCustomElement() {
    ...
    const components = ["mvx-pagination-ellipsis"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-pagination-ellipsis":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, PaginationEllipsis);
            }
            break;
    } });
}

export { PaginationEllipsis as P, defineCustomElement as d };
