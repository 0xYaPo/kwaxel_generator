...
const SidePanel = /*@__PURE__*/ proxyCustomElement(class SidePanel extends H {
    constructor() {
        ...
        this.sidePanelIdentifier = 'side-panel';
    }
    ...
    render() {
        return (h("div", { key: 'ae035c587004382bceca65238f31b5bf6d9087e6', onClick: this.handleOverlayClick.bind(this), class: classNames('side-panel-wrapper', {
                visible: this.shouldAnimate,
            }) }, h("mvx-side-panel-swiper", { key: 'aad596bab98d4793e13ebdc9124ff493332298fb', open: this.shouldAnimate, onSheetDismiss: () => this.close.emit(), sidePanelIdentifier: this.sidePanelIdentifier }, h("div", { key: '4b7951da9a1df327762322cf5dd63dd70f1d5235', id: this.sidePanelIdentifier, class: classNames('side-panel', { visible: this.shouldAnimate }, this.panelClassName) }, this.showHeader && (h("mvx-side-panel-header", { key: 'cdf691ef203fdaa80809eec9bc083162fd02856e', panelTitle: this.panelTitle, panelClassName: this.panelClassName, hasLeftButton: this.hasBackButton, onRightButtonClick: this.handleCloseClick.bind(this), onLeftButtonClick: this.handleBackClick.bind(this) })), h("div", { key: '3dfb894ba1b210d146f3e85c3b9e162f5f83e8f1', class: "side-panel-content" }, h("slot", { key: '4710d2e9b72b58bdb27adb9edfae56b8940859e0' }))))));
    }
    get el() { return this; }
...
function defineCustomElement() {
    ...
    const components = ["mvx-side-panel", "mvx-back-arrow-icon", "mvx-close-icon", "mvx-side-panel-header", "mvx-side-panel-swiper"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-side-panel":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, SidePanel);
            }
            break;
...
export { SidePanel as S, defineCustomElement as d };
