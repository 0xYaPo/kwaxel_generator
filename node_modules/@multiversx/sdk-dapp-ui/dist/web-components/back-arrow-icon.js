...
function defineCustomElement() {
    ...
    const components = ["mvx-back-arrow-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-back-arrow-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BackArrowIcon);
            }
            break;
    } });
}

export { BackArrowIcon as B, defineCustomElement as d };
