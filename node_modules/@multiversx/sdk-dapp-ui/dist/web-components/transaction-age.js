...
function defineCustomElement() {
    ...
    const components = ["mvx-transaction-age"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-transaction-age":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TransactionAge);
            }
            break;
    } });
}

export { TransactionAge as T, defineCustomElement as d };
