...
const Trim = /*@__PURE__*/ proxyCustomElement(class Trim extends H {
    ...
    render() {
        ...
        return (h("span", { key: '42791d461a70279e7eb48702de590ec889e36e0d', ref: el => (this.trimRef = el), class: classNames('trim', this.class, { overflow: this.overflow }), "data-testid": (_a = this.dataTestId) !== null && _a !== void 0 ? _a : DataTestIdsEnum.trim }, h("span", { key: '18a42afcc8f756f9362b944a6787e6bc36752123', ref: el => (this.hiddenTextRef = el), class: "hidden-text-ref" }, this.text), this.overflow ? (h("div", { class: "trim-wrapper" }, h("span", { class: "left" }, h("span", null, trimmedText.left)), h("span", { class: "ellipsis" }, ELLIPSIS), h("span", { class: "right" }, h("span", null, trimmedText.right)))) : (h("span", null, this.text))));
    }
    getTrimmedText() {
    ...
    get el() { return this; }
    static get style() { return trimCss; }
}, [256, "mvx-trim", {
        "text": [1],
        "class": [1],
...
function defineCustomElement() {
    ...
    const components = ["mvx-trim"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-trim":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, Trim);
            }
            break;
    } });
}

export { Trim as T, defineCustomElement as d };
