...
function defineCustomElement() {
    ...
    const components = ["mvx-default-transaction-icon-small"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-default-transaction-icon-small":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DefaultTransactionIconSmall);
            }
            break;
    } });
}

export { DefaultTransactionIconSmall as D, defineCustomElement as d };
