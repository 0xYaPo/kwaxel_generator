...
function defineCustomElement() {
    ...
    const components = ["mvx-wallet-connect-google-play-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-wallet-connect-google-play-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, WalletConnectGooglePlayIcon);
            }
            break;
    } });
}

export { WalletConnectGooglePlayIcon as W, defineCustomElement as d };
