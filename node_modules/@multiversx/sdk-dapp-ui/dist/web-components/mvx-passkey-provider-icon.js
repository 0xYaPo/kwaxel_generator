...
function defineCustomElement$1() {
    ...
    const components = ["mvx-passkey-provider-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-passkey-provider-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, PasskeyProviderIcon);
            }
            break;
    } });
}

const MvxPasskeyProviderIcon = PasskeyProviderIcon;
const defineCustomElement = defineCustomElement$1;

export { MvxPasskeyProviderIcon, defineCustomElement };
