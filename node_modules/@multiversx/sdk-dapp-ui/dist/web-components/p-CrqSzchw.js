...
const FaIcon = /*@__PURE__*/ proxyCustomElement(class FaIcon extends H {
    ...
    render() {
        ...
        return h("i", { class: this.class, innerHTML: iconHtml, title: this.description });
    }
    static get style() { return faIconCss; }
}, [256, "mvx-fa-icon", {
        "class": [1],
        "icon": [1],
        "description": [1]
...
function defineCustomElement() {
    ...
    const components = ["mvx-fa-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-fa-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, FaIcon);
            }
            break;
    } });
}

export { FaIcon as F, defineCustomElement as d };
