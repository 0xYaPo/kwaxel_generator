...
const SingleAngleRightIcon = /*@__PURE__*/ proxyCustomElement(class SingleAngleRightIcon extends H {
    ...
    render() {
        return (h("svg", { key: '60f9b4383266b6dc2cfcfc781bc9ecd1ffe08b1e', viewBox: "0 0 320 512", xmlns: "http://www.w3.org/2000/svg", class: { 'single-angle-right-icon': true, [this.class]: Boolean(this.class) } }, h("path", { key: '0d533b1815ed248d618a68733be0ad93390c8090', d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })));
    }
    static get style() { return singleAngleRightIconCss; }
}, [257, "mvx-single-angle-right-icon", {
        "class": [1]
    }]);
function defineCustomElement() {
    ...
    const components = ["mvx-single-angle-right-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-single-angle-right-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, SingleAngleRightIcon);
            }
            break;
    } });
}

export { SingleAngleRightIcon as S, defineCustomElement as d };
