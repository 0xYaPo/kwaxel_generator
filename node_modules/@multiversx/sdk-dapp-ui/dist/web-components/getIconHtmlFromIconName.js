import { s as solidIcons, l as library$1, i as icon } from './getIconHtmlFromIconDefinition.js';

function getIconHtmlFromIconName(iconName) {
    let faIcon;
...
export { getIconHtmlFromIconName as g };
