...
const FormatAmount = /*@__PURE__*/ proxyCustomElement(class FormatAmount extends H {
    ...
    renderInvalid() {
        var _a;
        return (h("span", { "data-testid": (_a = this.dataTestId) !== null && _a !== void 0 ? _a : DataTestIdsEnum.formatAmountComponent, class: this.class }, h("span", { class: "int-amount", "data-testid": DataTestIdsEnum.formatAmountInt }, "...")));
    }
    renderValid() {
        return (h("span", { "data-testid": this.dataTestId, class: classNames(this.class, 'format-amount') }, h("span", { class: "int-amount", "data-testid": DataTestIdsEnum.formatAmountInt }, this.valueInteger), this.valueDecimal && (h("span", { class: { decimals: true, [this.decimalClass]: Boolean(this.decimalClass) }, "data-testid": DataTestIdsEnum.formatAmountDecimals }, this.valueDecimal)), this.showLabel && this.label && (h("span", { class: {
                symbol: true,
                [this.labelClass]: Boolean(this.labelClass),
            }, "data-testid": DataTestIdsEnum.formatAmountSymbol }, this.label))));
    }
    static get style() { return formatAmountCss; }
}, [256, "mvx-format-amount", {
        "class": [1],
        ...
        "valueDecimal": [1, "value-decimal"],
        "valueInteger": [1, "value-integer"],
        "decimalClass": [1, "decimal-class"]
    }]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["mvx-format-amount"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-format-amount":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, FormatAmount);
            }
            break;
    } });
}

export { FormatAmount as F, defineCustomElement as d };
