...
import { a as SidePanelHeaderSlotEnum, d as defineCustomElement$9 } from './side-panel-header.js';
...
import { d as defineCustomElement$a } from './close-icon.js';
import { d as defineCustomElement$8 } from './wallet-connect-app-gallery-icon.js';
import { d as defineCustomElement$7 } from './wallet-connect-app-store-icon.js';
import { d as defineCustomElement$6 } from './wallet-connect-download.js';
import { d as defineCustomElement$5 } from './wallet-connect-google-play-icon.js';
import { d as defineCustomElement$4 } from './wallet-connect-scan.js';
import { d as defineCustomElement$3 } from './xportal-download-qr-icon.js';
import { d as defineCustomElement$2 } from './xportal-qr-code-preloader.js';
...
const WalletConnect = /*@__PURE__*/ proxyCustomElement(class WalletConnect extends H {
    ...
    render() {
        return (h(Fragment, { key: '59c01aebc0b484b0823a814404d48745b7b4e059' }, h("mvx-side-panel-header", { key: '0915ffe2022aca04ffd59f6d4ad6ed8f19062cbc', hasRightButton: true, hasLeftButton: !this.showScanPage, panelTitle: providerLabels.walletConnect, onLeftButtonClick: this.handlePageToggle.bind(this), onRightButtonClick: () => this.eventBus.publish(WalletConnectEventsEnum.CLOSE) }, !this.showScanPage && h("mvx-back-arrow-icon", { key: '3a3d1ba664b7c9ebeaac4490b8a1d066f274e7ea', slot: SidePanelHeaderSlotEnum.leftIcon }), h("mvx-close-icon", { key: '2a9bf5b200664443efa1d9c3dd7fda22a4551ab7', slot: SidePanelHeaderSlotEnum.rightIcon, class: "close-icon" })), h("div", { key: 'e1856e4010ab8673104a5a13c7529677bad38873', class: "wallet-connect" }, this.showScanPage ? (h("mvx-wallet-connect-scan", { qrCodeSvg: this.qrCodeSvg, onDownloadClick: this.handlePageToggle.bind(this), walletConnectDeepLink: this.walletConnectDeepLink })) : (h("mvx-wallet-connect-download", null)))));
    }
    get hostElement() { return this; }
    static get watchers() { return {
        "data": ["onDataChange"]
    }; }
    static get style() { return walletConnectCss; }
}, [257, "mvx-wallet-connect", {
        "data": [8],
        "qrCodeSvg": [1, "qr-code-svg"],
        "showScanPage": [32],
        "walletConnectDeepLink": [32],
        "getEventBus": [64]
    }, undefined, {
        "data": ["onDataChange"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["mvx-wallet-connect", "mvx-back-arrow-icon", "mvx-close-icon", "mvx-side-panel-header", "mvx-wallet-connect-app-gallery-icon", "mvx-wallet-connect-app-store-icon", "mvx-wallet-connect-download", "mvx-wallet-connect-google-play-icon", "mvx-wallet-connect-scan", "mvx-xportal-download-qr-icon", "mvx-xportal-qr-code-preloader"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-wallet-connect":
...
const MvxWalletConnect = WalletConnect;
const defineCustomElement = defineCustomElement$1;

export { MvxWalletConnect, defineCustomElement };
