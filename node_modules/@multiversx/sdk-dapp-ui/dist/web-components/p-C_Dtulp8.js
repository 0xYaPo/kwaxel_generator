...
const MagnifyingGlassIcon = /*@__PURE__*/ proxyCustomElement(class MagnifyingGlassIcon extends H {
    ...
    render() {
        return (h("svg", { key: '71108254cd30f2eacc12a739c9e1f436c4a66f75', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", class: { 'magnifying-glass-icon': true, [this.class]: Boolean(this.class) } }, h("path", { key: '3164ae33b9e22bb9c74a89fa4675be404b010946', d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" })));
    }
    static get style() { return magnifyingGlassIconCss; }
}, [257, "mvx-magnifying-glass-icon", {
        "class": [1]
    }]);
function defineCustomElement() {
    ...
    const components = ["mvx-magnifying-glass-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-magnifying-glass-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MagnifyingGlassIcon);
            }
            break;
    } });
}

export { MagnifyingGlassIcon as M, defineCustomElement as d };
