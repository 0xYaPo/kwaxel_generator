...
function defineCustomElement() {
    ...
    const components = ["mvx-xportal-download-qr-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-xportal-download-qr-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, XPortalDownloadQrIcon);
            }
            break;
    } });
}

export { XPortalDownloadQrIcon as X, defineCustomElement as d };
