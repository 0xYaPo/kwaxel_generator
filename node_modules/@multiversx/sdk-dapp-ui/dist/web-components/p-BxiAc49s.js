...
const SingleAngleDownIcon = /*@__PURE__*/ proxyCustomElement(class SingleAngleDownIcon extends H {
    ...
    render() {
        return (h("svg", { key: '52847e484d086c19d1d890d4427bf658d315daa0', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", class: { 'single-angle-down-icon': true, [this.class]: Boolean(this.class) } }, h("path", { key: 'eb063f43ab29e9e6837a4e232a3eaa667510287e', d: "M201.4 374.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 306.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" })));
    }
    static get style() { return singleAngleDownIconCss; }
}, [257, "mvx-single-angle-down-icon", {
        "class": [1]
    }]);
function defineCustomElement() {
    ...
    const components = ["mvx-single-angle-down-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-single-angle-down-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, SingleAngleDownIcon);
            }
            break;
    } });
}

export { SingleAngleDownIcon as S, defineCustomElement as d };
