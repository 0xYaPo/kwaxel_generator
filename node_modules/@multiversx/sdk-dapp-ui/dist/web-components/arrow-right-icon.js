...
const ArrowRightIcon = /*@__PURE__*/ proxyCustomElement(class ArrowRightIcon extends H {
    ...
    render() {
        return (h("svg", { key: '4e80e41879b0ef2ac459f1c33db0cdb417437aba', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", class: { 'arrow-right-icon': true, [this.class]: Boolean(this.class) } }, h("path", { key: '6e985a13aed6c4674f2e563771e547532ce9d18a', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })));
    }
    static get style() { return arrowRightIconCss; }
}, [257, "mvx-arrow-right-icon", {
        "class": [1]
    }]);
function defineCustomElement() {
    ...
    const components = ["mvx-arrow-right-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-arrow-right-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArrowRightIcon);
            }
            break;
    } });
}

export { ArrowRightIcon as A, defineCustomElement as d };
