...
const Button = /*@__PURE__*/ proxyCustomElement(class Button extends H {
    ...
    render() {
        return (h("button", { key: '3c5049c5139905f9931f27896a847dd5554fb8bf', "data-testid": this.dataTestId, onClick: this.buttonClick.emit.bind(this), disabled: this.disabled, class: {
                button: true,
                disabled: this.disabled,
                [this.size]: Boolean(this.size),
                [this.variant]: Boolean(this.variant),
                [this.class]: Boolean(this.class),
            } }, h("slot", { key: '7df1f9dacb38e1d47315fc21fd8f8c4cae543c87' })));
    }
