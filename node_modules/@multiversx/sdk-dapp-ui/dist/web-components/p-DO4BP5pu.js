...
const TransactionAccountName = /*@__PURE__*/ proxyCustomElement(class TransactionAccountName extends H {
    ...
    render() {
        if (this.name) {
            return (h("div", { class: classNames('text-truncate', this.class, 'transaction-account-name'), "data-testid": this.dataTestId, title: this.description }, this.name));
        }
        return (h("mvx-trim", { text: this.address, class: classNames(this.class, 'transaction-account-name'), dataTestId: this.dataTestId }));
    }
    static get style() { return transactionAccountNameCss; }
}, [256, "mvx-transaction-account-name", {
        "address": [1],
        "class": [1],
...
function defineCustomElement() {
    ...
    const components = ["mvx-transaction-account-name", "mvx-trim"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-transaction-account-name":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TransactionAccountName);
            }
            break;
        case "mvx-trim":
            if (!customElements.get(tagName)) {
...
export { TransactionAccountName as T, defineCustomElement as d };
