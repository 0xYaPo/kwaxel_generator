...
function defineCustomElement() {
    ...
    const components = ["mvx-arrow-up-right-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "mvx-arrow-up-right-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArrowUpRightIcon);
            }
            break;
    } });
}

export { ArrowUpRightIcon as A, defineCustomElement as d };
