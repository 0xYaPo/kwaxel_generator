...
var wrapEgldContract_exports = {};
__export(wrapEgldContract_exports, {
  wrapEgldContract: () => wrapEgldContract
});
module.exports = __toCommonJS(wrapEgldContract_exports);
const wrapEgldContract = {
  address: "erd1qqqqqqqqqqqqqpgqpv09kfzry5y4sj05udcngesat07umyj70n4sa2c0rp",
  balance: "259256323101682773803471",
  nonce: 0,
  timestamp: 0,
  shard: 1,
  ownerAddress: "erd1x39tc3q3nn72ecjnmcz7x0qp09kp97t080x99dgyhx7zh95j0n4szskhlv",
  assets: {
  ...
  rootHash: "hlCL39HYQwXZgXMa1UUBO8gYl5czCArPcbn8sQAveJc=",
  developerReward: "825805383696200195",
  isPayableBySmartContract: true,
  isUpgradeable: true,
  isReadable: true,
  isGuarded: false,
  isPayable: false,
  deployTxHash: "c29b7db5a4023f9a78ab85091620d9d652e4d9f99e7007537fbb30f3fd6a9682",
  deployedAt: 1695036320,
  txCount: 6752
};
...
//# sourceMappingURL=wrapEgldContract.cjs.map
