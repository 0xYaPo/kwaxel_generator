...
export declare enum TransactionIconTypeEnum {
    FAILED = "failed",
...
export interface IGetHistoricalTransactionsParams extends IBaseTransactionParams {
    transactionsSessions: Record<string, SessionTransactionType>;
}
export declare enum TransactionActionMethodTypeEnum {
    transfer = "Transfer",
    delegate = "Delegate",
    stake = "Stake",
