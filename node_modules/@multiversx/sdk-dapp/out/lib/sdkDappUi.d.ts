...
export type { ITransactionListItem, ITransactionListItemAsset, ITransactionListItemAction } from '@multiversx/sdk-dapp-ui/types/components/visual/transaction-list-item/transaction-list-item.types';
export declare function defineCustomElements(opts?: any): Promise<void>;
