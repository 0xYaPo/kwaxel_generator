...
class HWProvider {
    ...
    isLedgerTransportSupported() {
        return __awaiter(this, void 0, void 0, function* () {
            return ((yield this.isBLESupported()) ||
                (yield this.isWebUSBSupported()) ||
                (yield this.isWebHIDSupported()));
        });
    }
    isBLESupported() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    signTransaction(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (mustUseVersionWithOptions) {
                transaction.version = constants_1.TRANSACTION_VERSION_WITH_OPTIONS;
                console.info("Transaction version: ", transaction.version);
            }
            if (mustUsingHash) {
                transaction.options =
                    inputOptions | constants_1.TRANSACTION_OPTIONS_TX_HASH_SIGN;
                console.info("Transaction options: ", transaction.options);
            }
            const transactionComputer = new sdk_core_1.TransactionComputer();
            const serializedTransactionBuffer = Buffer.from(transactionComputer.computeBytesForSigning(transaction));
    ...
    cloneTransaction(transaction) {
        return sdk_core_1.Transaction.newFromPlainObject(transaction.toPlainObject());
    }
    ...
    signMessage(messageToSign) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const message = new sdk_core_1.Message({
                ...
                address: (_a = messageToSign.address) !== null && _a !== void 0 ? _a : sdk_core_1.Address.newFromBech32(this._account.address),
