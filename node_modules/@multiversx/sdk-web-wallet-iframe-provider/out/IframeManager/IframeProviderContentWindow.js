...
const IframeManager_styles_1 = require("./IframeManager.styles");
const defaultLoginBrading = {
...
class IframeProviderContentWindow {
    constructor(props) {
        ...
        this.walletAddress = '';
        this.loginBranding = defaultLoginBrading;
        this.loginType = constants_1.IframeLoginTypes.metamask;
        const { id, url, anchor, loginType } = props;
        this.loginType = loginType;
        this.container = (_a = constants_1.safeDocument.createElement) === null || _a === void 0 ? void 0 : _a.call(constants_1.safeDocument, 'div');
        ...
        this.iframe = (_e = constants_1.safeDocument.createElement) === null || _e === void 0 ? void 0 : _e.call(constants_1.safeDocument, 'iframe');
    ...
    buildHeader() {
        ...
        const headingElement = (_a = constants_1.safeDocument.createElement) === null || _a === void 0 ? void 0 : _a.call(constants_1.safeDocument, 'div');
    ...
    setLoginBranding(loginBranding) {
        this.loginBranding = Object.assign(Object.assign({}, this.loginBranding), loginBranding);
        this.buildHeader();
    }
    setUrl(url) {
...
//# sourceMappingURL=IframeProviderContentWindow.js.map