...
declare const IframeLoginTypesExtended: {
    readonly metamask: IframeLoginTypes.metamask;
    readonly passkey: IframeLoginTypes.passkey;
};
export type ExtendedIframeLoginType<T extends keyof typeof IframeLoginTypesExtended = keyof typeof IframeLoginTypesExtended> = T;
export type IframeProviderContentWindowProps<T extends keyof typeof IframeLoginTypesExtended = keyof typeof IframeLoginTypesExtended> = {
    id: string;
    url: string;
    anchor?: HTMLElement;
    loginType: T;
 ...
 *  }
 */
export type LoginBrandingType<T extends keyof typeof IframeLoginTypesExtended = keyof typeof IframeLoginTypesExtended> = {
    [key in T]: {
        icon: string;
        title: string;
    };
